...
class LainManHomeMenuTile extends StatelessWidget {
  int index;
  LainManHomeMenuTile({this.index});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(Variables.lainManHomeMenuIcon[index], size: size.width*.10, color: CustomColors.whiteColor),
          Text(
            Variables.lainManHomeMenuText[index],
            maxLines: 3,
